...
def instalar_msi():
    """Instala o MSI se necessário e executa comandos adicionais."""
    ...
    # Perguntar se o usuário deseja instalar o MSI
    resposta = input(f"{Fore.GREEN}Deseja instalar o Arduino CLI? Digite 1 para sim ou 0 para não: ")
    ...
    if resposta == '1':
        ...
        print(f"{Fore.GREEN}Instalação do Arduino CLI ignorada.")

    # Executar comandos adicionais independentemente da instalação
    comandos_adicionais = [
...
# Chamar a função para instalação
#instalar_msi()
